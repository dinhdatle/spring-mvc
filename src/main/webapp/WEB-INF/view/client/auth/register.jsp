                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-floating mb-3 mb-md-0">
                                                                    <form:input path="firstName"
                                                                        cssClass="form-control ${errors.hasFieldErrors('firstName') ? 'is-invalid' : ''}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-floating">
                                                                    <form:input path="lastName"
                                                                        cssClass="form-control ${errors.hasFieldErrors('lastName') ? 'is-invalid' : ''}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-floating mb-3 mb-md-0">
                                                                    <form:input path="password"
                                                                        cssClass="form-control ${errors.hasFieldErrors('password') ? 'is-invalid' : ''}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-floating mb-3 mb-md-0">
                                                                    <form:input path="confirmPassword"
                                                                        cssClass="form-control ${errors.hasFieldErrors('confirmPassword') ? 'is-invalid' : ''}"
